...
# Example: bash run.sh verb_color_0316 /root/workspace/data_gen/0316_verb_color/lerobot_dataset
# bash run.sh verb_color_200_ours /root/workspace/data_gen/verb_color_200_0323/ours
set -euo pipefail
cd "$(dirname "$0")"
